! function(t, e) {
    ...
    return function(t) {
        ...
        var T = function(t) {
            function e(t) {
                r(this, e), s(Object.getPrototypeOf(e.prototype), "constructor", this).call(this, t), this.bootTryDelay = this.options.bootTryDelay || 500, this.bootMaxTryCount = this.options.bootMaxTryCount || 6, this.bootTryCount = 0, this.isBootable() ? (this.appId = this.options.appId || A, this.deviceState = E.IDLE, this.embedScript()) : this.disable()
            }
            return o(e, t), a(e, [{
                key: "version",
                get: function() {
                ...
                key: "enable",
                value: function() {
                    s(Object.getPrototypeOf(e.prototype), "enable", this).call(this), this.render(), this.embedScript()
                }
            }, {
                key: "embedScript",
                value: function() {
                    var t = this;
                    if (window.chrome && window.chrome.cast && window.chrome.cast.isAvailable) this.bootstrapCastApi();
                    else {
                        var e = document.createElement("script");
                        e.setAttribute("type", "text/javascript"), e.setAttribute("async", "async"), e.setAttribute("src", "https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"), e.onload = function() {
                ...
                value: function() {
                    var t = this;
                    return this.bootTryCount++, this.bootTryCount > this.bootMaxTryCount ? (this.bootTryCount = 0, c.Log.warn("GCastApi bootstrap timeout"), void this.disable()) : void(window.chrome ? (this.bootTryCount = 0, window.chrome.cast && window.chrome.cast.isAvailable ? (this.appId = this.appId || A, this.initializeCastApi()) : window.__onGCastApiAvailable = function(e, n) {
                        e ? (t.appId = t.appId || A, t.initializeCastApi()) : (c.Log.warn("GCastApi error", n), t.disable())
                    }) : setTimeout(function() {
                        t.bootstrapCastApi()
                    }, this.bootTryDelay))
                }
                ...
                key: "sessionListener",
                value: function(t) {
                    c.Log.debug(this.name, "new session id:" + t.sessionId), this.newSession(t)
                }
            }, {
                key: "sessionUpdateListener",
                value: function() {
                    this.session && (c.Log.debug(this.name, this.session.status), this.session.status === chrome.cast.SessionStatus.STOPPED && (this.sessionStopped(), this.session = null))
                }
            }, {
                key: "receiverListener",
                value: function(t) {
                    t === chrome.cast.ReceiverAvailability.AVAILABLE ? (c.Log.debug(this.name, "receiver found"), this.show()) : (c.Log.debug(this.name, "receiver list empty"), this.hide())
                }
            }, {
                key: "launchSuccess",
                value: function(t) {
                    this.renderConnected(), clearInterval(this.connectAnimInterval), this.core.mediaControl.resetKeepVisible(), c.Log.debug(this.name, "launch success - session: " + t.sessionId), this.newSession(t)
                }
            }, {
                key: "launchError",
                value: function(t) {
                    c.Log.debug(this.name, "error on launch", t), this.renderDisconnected(), clearInterval(this.connectAnimInterval), this.core.mediaControl.resetKeepVisible(), this.container.play()
                }
            }, {
                key: "loadMediaSuccess",
                value: function(t, e) {
                    c.Log.debug(this.name, "new media session", e, "(", t, ")"), this.originalPlayback = this.playback;
                    ...
                    this.src = this.originalPlayback.src, this.playbackProxy = new l.default(n), this.playbackProxy.render(), this.core.$el.addClass("chromecast-active"), this.mediaSession = e, this.originalPlayback.$el.remove();
                    var i = this.container;
                    i.$el.append(this.playbackProxy.$el), i.stopListening(), i.playback = this.playbackProxy, i.bindEvents(), i.settingsUpdate()
                }
            }, {
                key: "loadMediaError",
                value: function(t) {
                ...
                value: function(t) {
                    var e = this;
                    this.session = t, this.deviceState = E.ACTIVE, this.renderConnected(), t.addUpdateListener(function() {
                ...
                value: function() {
                    ...
                    var t = this.currentTime,
                        e = void 0;
                    this.mediaSession && (e = this.mediaSession.playerState, this.mediaSession = null), this.core.$el.removeClass("chromecast-active"), this.core.load(this.src || this.core.options.sources);
                ...
                value: function() {
                    ...
                    i.autoplay = !0, this.currentTime && (i.currentTime = this.currentTime), this.session.loadMedia(i, function(e) {
                ...
                value: function(t) {
                    ...
                    i.contentType = this.options.contentType || n, i.customData = this.options.customData;
                ...
                value: function() {
                    var t = this;
                    this.currentTime = this.container.getCurrentTime(), this.container.pause(), chrome.cast.requestSession(function(e) {
                        ...
                        clearInterval(t.connectAnimInterval), t.connectAnimInterval = setInterval(function() {
                            t.$el.html(n[e]), e = (e + 1) % 3
                        }, 600), t.core.mediaControl.setKeepVisible()
                    }()
                }
            }, {
                ...
                key: "containerPlay",
                value: function() {
                    !this.session || this.mediaSession && "IDLE" !== this.mediaSession.playerState && "PAUSED" !== this.mediaSession.playerState || (c.Log.debug(this.name, "load media"), this.loadMedia())
                }
            }, {
                key: "renderConnected",
                value: function() {
                ...
                key: "render",
                value: function() {
                    return this.session ? this.renderConnected() : this.renderDisconnected(), this.core.mediaControl.$el.find(".media-control-right-panel[data-media-control]").append(this.$el), this.$style && this.$style.remove(), this.$style = c.Styler.getStyleFor(p.default, {
                        baseUrl: this.core.options.baseUrl
                    }), this.core.$el.append(this.$style), this
                }
            }], [{
                key: "mimeTypeFor",
                value: function(t) {
        ...
        var a = function() {
            ...
            p = function(t) {
                function e(t) {
                    var n = this;
                    r(this, e), s(Object.getPrototypeOf(e.prototype), "constructor", this).call(this, t), this.src = t.src, this.currentMedia = t.currentMedia, this.mediaControl = t.mediaControl, this.currentMedia.addUpdateListener(function() {
                        return n.onMediaStatusUpdate()
                    }), this.settings = t.settings;
                    var i = function(t) {
                        return "volume" != t
                    };
                    this.settings.default && (this.settings.default = this.settings.default.filter(i)), this.settings.left && (this.settings.left = this.settings.left.filter(i)), this.settings.right && (this.settings.right = this.settings.right.filter(i))
                }
                return o(e, t), a(e, [{
                    key: "name",
                    get: function() {
                    ...
                    value: function() {
                        var t = this.template();
                        this.$el.html(t), this.options.poster ? this.$(".chromecast-playback-background").css("background-image", "url(" + this.options.poster + ")") : this.$(".chromecast-playback-background").css("background-color", "#666")
                    }
                }, {
                    key: "play",
                    value: function() {
                    ...
                    key: "pause",
                    value: function() {
                        this.stopTimer(), this.currentMedia.pause(), this.getPlaybackType() === c.Playback.LIVE && this.trigger(c.Events.PLAYBACK_DVR, !0)
                    }
                }, {
                    key: "stop",
                    value: function() {
                    ...
                    value: function(t) {
                        ...
                        n.currentTime = t, this.currentMedia.seek(n, function() {
                            return e.startTimer()
                        }, function() {
                    ...
                    value: function() {
                        this.mediaControl.changeTogglePlay(), this.isPlaying() && !this.timer && this.startTimer(), "BUFFERING" === this.currentMedia.playerState ? (this.isBuffering = !0, this.trigger(c.Events.PLAYBACK_BUFFERING, this.name)) : "PLAYING" === this.currentMedia.playerState ? (this.isBuffering && (this.isBuffering = !1, this.trigger(c.Events.PLAYBACK_BUFFERFULL, this.name)), this.prevState !== this.currentMedia.playerState && this.trigger(c.Events.PLAYBACK_PLAY, this.name)) : "IDLE" === this.currentMedia.playerState ? (this.isBuffering && (this.isBuffering = !1, this.trigger(c.Events.PLAYBACK_BUFFERFULL, this.name)), this.trigger(c.Events.PLAYBACK_ENDED, this.name)) : "PAUSED" === this.currentMedia.playerState && this.prevState !== this.currentMedia.playerState && this.trigger(c.Events.PLAYBACK_PAUSE, this.name), this.prevState = this.currentMedia.playerState
                    }
                }, {
        ...
        function o(t, e) {
            return t = "number" == typeof t || d.test(t) ? +t : -1, e = null == e ? y : e, t > -1 && t % 1 == 0 && t < e
        }
        ...
        function u(t) {
            ...
            var e = t.length;
            e = e && a(e) && (p(t) || h(t)) && e || 0;
            for (var n = t.constructor, i = -1, r = "function" == typeof n && n.prototype === t, s = Array(e), u = e > 0; ++i < e;) s[i] = i + "";
            for (var l in t) u && o(l, e) || "constructor" == l && (r || !v.call(t, l)) || s.push(l);
            return s
        }
        var l = n(10),
            h = n(11),
        ...
        function i(t) {
            return a(function(e, n) {
                var i = -1,
                    ...
                    c = a > 2 ? n[2] : void 0,
                    u = a > 1 ? n[a - 1] : void 0;
                for ("function" == typeof s ? (s = r(s, u, 5), a -= 2) : (s = "function" == typeof u ? u : void 0, a -= s ? 1 : 0), c && o(n[0], n[1], c) && (s = a < 3 ? void 0 : s, a = 1); ++i < a;) {
                    var l = n[i];
                    l && t(e, l, s)
                }
                return e
        ...
        function r(t, e) {
            return t = "number" == typeof t || c.test(t) ? +t : -1, e = null == e ? u : e, t > -1 && t % 1 == 0 && t < e
        }
